...
if(modo_jogo == 1):
    print("Porcentagem de vitorias do player_1 =", ((vitorias_player_1 / numero_partidas_total) * 100))
    print("Porcentagem de vitorias do player_2 =",((vitorias_player_2 / numero_partidas_total) * 100))
elif(modo_jogo == 2):
    print("Porcentagem de vitorias do player_1 =", ((vitorias_player_1 / numero_partidas_total) * 100))
    print("Porcentagem de vitorias do Computador =",((vitorias_player_2 / numero_partidas_total) * 100))
else:
    print("Porcentagem de vitorias do Computador1 =",((vitorias_player_1 / numero_partidas_total) * 100))
    print("Porcentagem de vitorias do Computador2 =",((vitorias_player_2 / numero_partidas_total) * 100))
